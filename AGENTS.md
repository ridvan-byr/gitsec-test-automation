...
Retries should improve resilience,
not hide bugs.
...
When retries indicate flaky tests

QA Review Rules

More than X retries

Retry without investigation
...
Evaluate fixture usage and shared setup quality.
...
Use reusable custom fixtures where appropriate.

## Isolation Review Standards

# Isolation Review Rules
...
Names should describe user behavior, not implementation.

## Parallel Review Standards

# Parallel Execution Review Rules
...
Isolate test data and execution.

## Retry Review Standards

# Retry Review Rules

## Purpose

Detect retries hiding unstable tests.
...
Fix root cause before increasing retries.

## Waiting Review Standards
